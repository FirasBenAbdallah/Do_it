...
struct AddEvent: View {
    ...
    func addEvent() {
        ...
        guard let url = URL(string: "172.17.11.114:3001/publication2") else { return }
        var dateString = ""
        var dateString2 = ""
        //var base64 = ""
       ...
       let params = ["name": username, "address": location,"start": dateString,"end": dateString2,"description": desc, "pde": "base64"]
...
struct AddEvent: View {
    ...
    func addEvent() {
            // Set the URL of your Node.js server
            guard let url = URL(string: "http://172.17.11.114:3000/addevent") else { return }
        var dateString = ""
        var dateString2 = ""
